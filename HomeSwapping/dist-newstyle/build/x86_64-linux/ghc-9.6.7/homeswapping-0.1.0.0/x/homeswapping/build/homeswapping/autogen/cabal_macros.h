...
/* package homeswapping-0.1.0.0 */
#ifndef VERSION_homeswapping
#define VERSION_homeswapping "0.1.0.0"
#endif /* VERSION_homeswapping */
#ifndef MIN_VERSION_homeswapping
#define MIN_VERSION_homeswapping(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_homeswapping */
...
#define CURRENT_COMPONENT_ID "homeswapping-0.1.0.0-inplace-homeswapping"
